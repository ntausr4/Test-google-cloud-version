...
import com.errui.lable.LabelApp;
...
public class LabelAppIT {
  ...
  @Test public void labelImage_cat_returnsCatDescription() throws Exception {
	...
	System.out.println("Google Cloud Vision API Java Image Labeling example:");
	System.out.println(labels.get(0).toPrettyString());
